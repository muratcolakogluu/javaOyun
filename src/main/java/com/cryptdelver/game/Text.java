...
public enum Text {
    ...
    PATH_GUARD_WHAT("deri zırh ve fazladan can — hata payın var",
            "leather armor and extra health — room to make mistakes"),
    PATH_ROGUE("Haydut", "Cutpurse"),
    PATH_ROGUE_WHAT("aceleyle büyülü kılıç, zırh yok — önce sen vur",
            "a hasted blade, no armor — strike first"),
    PATH_TRADER("Tüccar", "Trader"),
    PATH_TRADER_WHAT("takım yok, 150 altın ve bir iksir — yolda satın al",
            "no gear, 150 gold and a potion — buy it on the way"),
