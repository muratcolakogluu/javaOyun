...
public enum Text {
    ...
    PATH_ROGUE("Haydut", "Cutpurse"),
    PATH_ROGUE_WHAT("aceleyle büyülü kılıç, zırh yok · Q: kaçış adımı",
            "a hasted blade, no armor · Q: dash"),
    ...
    KEY_DASH("Q", "Q"),
    KEY_DASH_WHAT("yol yeteneğin (menüde hangisi olduğu yazılı)",
            "the skill your path gave you (the menu says which)"),
    KEY_PARRY("R", "R"),
    KEY_PARRY_WHAT("savuştur: inen vuruşu tam anında karşıla",
            "parry: meet the blow as it lands"),
    KEY_TAKE("F", "F"),
    ...
    SUMMARY_KILLER("Seni %s öldürdü.", "%s killed you."),
    SUMMARY_KILLER_UNKNOWN("Zindan seni yuttu.", "The dungeon swallowed you."),
    SUMMARY_DEPTH("En derin kat", "Deepest floor"),
    SUMMARY_RETURNS("Geri dönüş", "Climbs back up"),
    SUMMARY_KILLS("Devirdiğin düşman", "Enemies felled"),
    SUMMARY_GOLD("Topladığın altın", "Gold gathered"),
    SUMMARY_PURSE("Kesende kalan", "Left in the purse"),
    SUMMARY_BOUGHT("Satıcıdan aldığın", "Bought from pedlars"),
    SUMMARY_TIME("Geçen süre", "Time spent"),
    SUMMARY_SECONDS("%.0f sn", "%.0f s"),
    SUMMARY_CARRIED("Elinde: %s   ·   Üstünde: %s",
            "In hand: %s   ·   On you: %s"),
    SUMMARY_BAREHANDED("çıplak el", "bare hands"),
    ...
    ITEM_ARROW("Ok", "Arrow"),
    ITEM_KEY("Mahzen Anahtarı", "Vault Key"),
    ITEM_KEY_INFO("kilitli mahzeni açar", "opens the locked vault"),
    ...
    MSG_PARRIED("Savuşturdun! %s sersemledi.", "Parried! %s is staggered."),
    MSG_SHOCKWAVE("Sarsıntı: %d düşman sersemledi.", "Shockwave: %d enemies staggered."),
    MSG_BRIBED("%d düşman dağıldı (-%d altın).", "%d enemies scattered (-%d gold)."),
    MSG_BRIBE_BROKE("Rüşvet için %d altın gerek.", "A bribe needs %d gold."),
    MSG_DEFLECTED("Oku savuşturdun.", "You deflected the arrow."),
    ...
    MSG_KEY_DROPPED("%s anahtarı düşürdü.", "%s dropped the key."),
    MSG_KEY_IDLE("Anahtar kapıda işe yarar.", "The key is for the door."),
    MSG_VAULT_LOCKED("Mahzen kilitli. Anahtarı kattaki biri taşıyor.",
            "The vault is locked. Someone on this floor carries the key."),
    MSG_VAULT_OPENED("Mahzen açıldı.", "The vault is open."),
    HINT_OPEN_VAULT("F ile mahzeni aç", "F to open the vault"),
    HINT_VAULT_LOCKED("kilitli — anahtar gerek", "locked — a key is needed"),
    ENEMY_KEEPER("Anahtarcı", "Keeper"),
    ...
    MSG_PATH_CHOSEN("%s olarak zindana indin.", "You descend as %s."),
